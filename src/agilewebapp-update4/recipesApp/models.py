...
class Recipe(models.Model):
    ...
    cost = models.DecimalField('total cost', max_digits=5, decimal_places=2, validators=[
    ...
    cookingTime = models.PositiveSmallIntegerField('cooking time',
                                                   validators=[
                                                       MaxValueValidator(120, message='The cooking time is too long')])
    # add default
    skillsLevel = models.CharField('skills level', max_length=30, choices=skillsChoice)
    recipeCategory = models.CharField('recipe category', default=('Other', 'Other'), max_length=30,
